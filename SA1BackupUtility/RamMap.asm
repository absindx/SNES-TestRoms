...
%DefineRamNext(TestIRamSaveBytes,		2)	; $0001
%DefineRamNext(TestIRamSaveBits,		2)	; $0003
%DefineRamNext(TestBwRamSaveBytes,		2)	; $0005
%DefineRamNext(TestBwRamSaveBits,		2)	; $0007
%DefineRamNext(TestSramSize,			3)	; $0009

	org	$00C0
%DefineRamNext(ScratchMemory,			16)	; $00C0
	;org	$00D0
%DefineRamNext(StackTeporary,			2)	; $00D0
%DefineRamNext(Initialized,			1)	; $00D2
%DefineRamNext(DuringNMI,			1)	; $00D3
%DefineRamNext(FrameCounter,			1)	; $00D4
%DefineRamNext(JoypadInput,			2)	; $00D5 High   +1, Low    +0
%DefineRamNext(JoypadPress,			2)	; $0077 BYsS udlr, AXLR 0123


warnings push
warnings disable W1009
%DefineRam(BackupTestIRam,			$000700, 256)	; $000700-$0007FF
%DefineRam(BackupTestIRamMapping,		$003700, 256)	; $003700-$0037FF
%DefineRam(BackupTestBwRam,			$400000, 256)	; $400000-$4000FF
%DefineRam(BackupTestBwRamMapping,		$006000, 256)	; $006000-$0060FF
warnings pull

!TestMemorySize	= 256
!TestMemoryBits	= !TestMemorySize*8
!MemoryDumpSize	= $20
