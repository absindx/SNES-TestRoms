...
CartridgeInformation:
	...
	db	"SA-1 OPENBUS UTIL"			; $00FFC0 : Game title
	pad $00FFD5
...
incbin	"Tilemap/Tilemap_Main.bin"
		...
		%DataAsciiNumber(!VersionMinor, 2, Zero)
		org	.Tilemap+$131
		%DataAsciiHex(!SnesOpenBusValue, 2, Zero)
		org	.Tilemap+$13C
		%DataAsciiHex(!SnesOpenBusValue, 2, Zero)
		pullpc
